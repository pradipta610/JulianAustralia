...
@section('title', 'Super Admin List | Julian Photography')
@section('content')
            ...
            <div class="flex items-center justify-between pb-4">
                <div>
                    ...
                    <button
                        ...
                        type="button">
                        <a href="{{ route('superadminList.create') }}">+ Super Admin Users</a>
                    </button>
                </div>
            </div>
                    ...
                    @foreach ($data as $item)
                        <tr
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('superadminList.edit', $item->id) }}"
