    ...
    <div class="p-4">
        <div class="p-4 md:text-center text-justify ">
            ...
            <div class="md:w-[70%] justify-center items-center mx-auto">
                <p class="font-thin font-gallery-desc text-lg my-4 mx-2"> <span class="font-sans font-bold text-xl mr-2">"</span>From the big day of your wedding, to those cozy casual days, to the surprise proposal that finally sealed the deal – why not capture them all with lovely couple photos? You won't regret it, and you'll have something to cherish for many years to come!<span class="font-bold text-xl ml-2">"</span></p>
            </div>
        </div>
