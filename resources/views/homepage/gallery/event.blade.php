        ...
        <div class="p-4 md:text-center text-justify ">
            ...
            <div class="md:w-[70%] justify-center items-center mx-auto">
                <p class="font-thin font-gallery-desc text-lg my-4 mx-2"> <span
                        class="font-sans font-bold text-xl mr-2">"</span>As every moment counts, what better way to remember
                    an occasion than with a photoshoot? Perfect for birthdays, graduations, christenings, and bridal parties
                    — capture the excitement of life’s little moments before they fade away with a set of unforgettable
                    pictures to look back on! <span class="font-bold text-xl ml-2">"</span></p>
            </div>
        </div>
