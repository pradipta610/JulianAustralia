        ...
        <div class="md:py-14 ">
            <div class="flex gap-7 md:flex-row flex-col p-4 my-14">
                <div class="flex items-start flex-col  justify-center " data-aos="fade-up">
                    ...
                    <button type="button"
                        class="text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Booking
                        Now!</button>
                </div>
